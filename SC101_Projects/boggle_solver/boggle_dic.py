...
Name: Monica Peng
----------------------------------------
This file put the dictionary in a dictionary and excludes the prefix check function.
"""
...
def search_word(boggle, words_list, i, j, current_s, found_words):
	...
	if len(current_s) >= 4 and current_s in words_list and current_s not in found_words:
